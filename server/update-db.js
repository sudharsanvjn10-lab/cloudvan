...
async function updateDatabase() {
  ...
  try {
    ...
    await connection.execute(`UPDATE team_members SET name = 'Jeevanantham R.', title = 'Founder & Director', bio = 'Lead Oracle HCM Cloud Solution Architect with over 20+ years of extensive experience and expertise. Oversees Service Delivery and Global operations. Prior to founding Cloud Vantage, held key positions at Bahwan Cybertek, Hexaware Transsys, and others.' WHERE id = 1`);
